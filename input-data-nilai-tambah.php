...
<form action="input-data-nilai-tambah.php" method="POST">
    ...
    <input type="number" name="nis" placeholder="Ex. 1234321" /> <br>

    <label for="nama_lengkap">Nama Lengkap  : </label>
    <input type="text" name="nama_lengkap" placeholder="Ex. Egi Renaldi" /> <br>
    
    <label for="kelas">Kelas :</label>
    <input type="text" name="kelas" placeholder="Ex. 11 RPL 1" /><br>

    <label for="kehadiran">Kehadiran :</label>
    <input type="number" name="kehadiran" placeholder="Ex. 85"><br>
